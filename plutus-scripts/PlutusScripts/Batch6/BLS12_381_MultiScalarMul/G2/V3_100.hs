...
module PlutusScripts.Batch6.BLS12_381_MultiScalarMul.G2.V3_100 where
...
succeedingMultiScalarMulPolicyScript1 =
  $$(compile [||mkSucceedingMultiScalarMulPolicy1||])
    `unsafeApplyCode` liftCode plcVersion100 succeedingMultiScalarMulParams1

succeedingMultiScalarMulPolicyScript2
  :: CompiledCode (P.BuiltinData -> P.BuiltinUnit)
succeedingMultiScalarMulPolicyScript2 =
  $$(compile [||mkSucceedingMultiScalarMulPolicy2||])
    `unsafeApplyCode` liftCode plcVersion100 succeedingMultiScalarMulParams2
